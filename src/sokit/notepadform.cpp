...
NotepadForm::NotepadForm(QWidget *p, Qt::WindowFlags f) : QWidget(p, f) { setupUi(); }
...
void NotepadForm::setupUi() {
  ...
  auto n = new QShortcut(QKeySequence(Qt::CTRL | Qt::Key_Tab), this);
  auto l = new QShortcut(QKeySequence(Qt::CTRL, Qt::SHIFT, Qt::Key_Tab), this);
  n->setObjectName("n");
  l->setObjectName("l");
