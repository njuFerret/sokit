...
const char *TK::socketTypeName(bool tcp) { return tcp ? "TCP" : "UDP"; }
...
QString TK::ipstr(const QHostAddress &addr, quint16 port) { return addr.toString() + ':' + QString::number(port); }
